...
const Hero = () => {
  ...
  <a href="#" class="text-gray-500 hover:text-gray-700 transition duration-300 ease-in-out transform hover:animate-bounce mx-4">
    <i class="fab fa-github text-2xl"></i>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} hover:text-gray-700 transition duration-300 ease-in-out transform hover:animate-bounce text-white`}>Hi , I'm<span className="text-[#915eff]"> Asad shaikh</span> </h1>
