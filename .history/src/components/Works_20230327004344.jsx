...
const ProjectCard = ({index,name,description,tags,image,source_code_link})=>{
  return( 
    ...
    <Tilt
      ...
      className='bg-[#09093e] p-5 rounded-2xl sm:w-[360px] w-full'
    >
...
export default SectionWrapper(Works,"","bg-gradient-to-r from-gray-900 via-slate-900 to-custom-bg-color")