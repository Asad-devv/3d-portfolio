...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt className="hover:scale-10 transition xs:w-[250px] w-full  ">
      <div
        data-aos="fade-up"
        data-aos-duration={`${750*index}`}        className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card"
...
const About = () => {
  return (
    <>
      ...
      <LazyLoad>
      {/* <div className=" flex mt-10 flex-wrap  justify-center items-center gap-10 hidden sm:flex"> */}
      <div className=" flex mt-10 flex-wrap sm:block justify-center items-center gap-10">
...
export default SectionWrapper(About, "about", "bg-gradient-to-r from-gray-900 via-gray-900 to-custom-bg-color");
