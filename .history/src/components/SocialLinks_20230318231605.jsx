...
const SocialLinks = () => {
  return (
    <div className="flex z-50 mt-4 space-x-4">
      <a
        href="#"
        className="text-gray-200 hover:text-blue-500 transform hover:scale-110 animate-bounce transition duration-300"
      >
        <i className="fab fa-linkedin fa-2x"></i>
      </a>
      <a
        href="#"
        className="text-gray-200 animate-pulse hover:text-blue-500 transform hover:scale-110 transition duration-300"
      >
