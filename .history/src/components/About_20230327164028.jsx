...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt className="hover:scale-10 transition xs:w-[250px] w-full  ">
      <div
        data-aos="fade-up"
        data-aos-duration={`${850*index}`}        className="w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card"
...
const About = () => {
  return (
    <>
      ...
      <LazyLoad>
      <div className=" flex sm:hidden md:block lg:block block mt-10 flex-wrap justify-center items-center gap-10">
