    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[28px] font-black font- cursor-pointer">
         <span className="text-gray-200 text-[30px] " >&lt;</span>Asad Ullah<span className="text-gray-200 text-[30px]  "> /&gt;</span>
