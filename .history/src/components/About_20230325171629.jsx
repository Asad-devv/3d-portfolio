    ...
    <>
      ...
      <div className="flex bg-purplae-900 flex-col md:flex-row ">
        <p className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
          ...
          technology. bg-gradient-to-r from-purple-800 via-violet-900 to-purple-800
        </p>
...
export default SectionWrapper(About, "about", "bg-gradient-to-r from-purple-900 via-violet-900 to-purple-900");
