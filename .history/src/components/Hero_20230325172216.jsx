...
const Hero = () => {
  return (
    <section className='relative w-full h-[105vh] mx-auto'>
      <div className={`${styles.paddingX} z-50 inset-0 absolute top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText}  text-white`}>Hi , I'm<span className="text-[#915eff]"> Asad Ullah</span> </h1>
