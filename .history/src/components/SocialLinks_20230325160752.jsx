...
const SocialLinks = () => {
  ...
  return (
    ...
    <div className="flex mb-5 pb-5 z-50 mt-4 space-x-4">
      ...
      <button  className="border-[1px] p-2 border-gradient-red-blue"><a href="https://drive.google.com/file/d/1lxCD_L-2mBmqH2a30npEKu9VopGkv9ZP/view?usp=sharing" download >DOWNLOAD CV</a></button>
    </div>
