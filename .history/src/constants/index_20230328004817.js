import {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Web application that fetches the user's location to sfor different types of hotels and restaurent ac, view estimated salary ranges for positions, and locate available jobs based on their current location.",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
