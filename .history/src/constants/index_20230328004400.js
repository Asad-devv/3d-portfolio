  ...
  const projects = [
    {
      name: "Sneakinn",
      description:
        "E-commerce platform that allows users to search, explore, and  rentals from various providers, providing a convenient and efficient solution for transportation needs.",
      tags: [
        {
          name: "StockX API",
