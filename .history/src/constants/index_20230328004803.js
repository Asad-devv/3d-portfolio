import {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Web application that fetches the users to search for different types of hotels and restaurent ac, view estimated salary ranges for positions, and locate available jobs based on their current location.",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
