import {
  ...
  const projects = [
    ...
    },
    {
      name: "Donut Website",
      description:
        "A Simple Web application that has a simple donut website as a practice project using Three.js. . The website features a 3D donut that users can interact with by rotating and zooming in and out.",
      tags: [
        {
          name: "ThreeJS",
          color: "blue-text-gradient",
