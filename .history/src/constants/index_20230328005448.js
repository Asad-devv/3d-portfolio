import {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Web application that fetches the user's location and displays different hotels,restaurent .it allows users to search for hotels, restaurants according to their preferences.",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
